...
from wtforms import StringField, SubmitField, DateField, IntegerField, BooleanField, TextAreaField, SelectField, SelectMultipleField, RadioField
...
class CompanyForm(FlaskForm):
    ...
    emergency_procedures_flag = RadioField('Do you have procedures for dealing with emergencies?', choices=[(1,'yes'),(0,'no')], coerce=int)
